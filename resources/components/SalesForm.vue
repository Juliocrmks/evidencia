                ...
                <v-col>
                    <v-card max-height="800">
                        ...
                        <v-list lines="two" subheader>
                            ...
                            <v-list-item v-for="material in selectedMaterials " title="Material">
                                {{material.material}}
                                <v-slider v-model="slider" class="align-center" :step="1" :max="max" :min="min"
                                    hide-details>
...
export default {
    data: () => ({
        ...
        address: null,
        loading: false,
        materials: [{ material: 'Wood' }, { material: 'Metal' }, { material: 'Glass' }, { material: 'Marble' },],
